...
// src/functions/orderBook/handler.ts
__export(exports, {
  main: () => main
});
...
var getData = async (param) => {
  try {
    console.log("sddddddddddddddddddddddddddddddd==========>>>>>>>>>>>>>>>> ", param.authorName);
    const data = {
